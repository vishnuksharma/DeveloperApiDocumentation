...
const ReferenceComponent = ({id, getDocumentDataById, documentData, isDataLoading}) =>{
  useEffect(() => {
    getDocumentDataById({apiName: 'reference' , id});
...
export default connect(mapState, mapDispatch)(ReferenceComponent);